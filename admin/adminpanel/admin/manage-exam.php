        ...
        <div id="refreshData">
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <div class="btn-actions-pane-right" style="float: right; margin-bottom: 13px;">
                <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalForAddQuestionExcelDoc">View Excel File Format</button>
                <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modalForAddQuestionExcel">Import Question excel</button>
                      ...
                      if ($selQuest->rowCount() > 0) {  ?>
                        <div class="table-responsive">
                          <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            <thead>
                              <tr>
                                <th class="text-left pl-1">Department Name</th>
