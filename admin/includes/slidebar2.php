<div class="app-sidebar sidebar-shadow">
    <div class="app-header__logo">
        <div class="logo-src" style="background-position: center;background-repeat: repeat-y;"></div>
    ...
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="app-sidebar__heading">TEST EXAM</li>
                <li>
                    <a href="#">
                        <i class="metismenu-icon pe-7s-display2"></i>
                        Test Exam
                    ...
                    <ul>
                        ...
                        if ($selExam->rowCount() > 0) {
                            while ($selExamRow2 = $selExam->fetch(PDO::FETCH_ASSOC)) { 
                                ...
                                ?>
                                <li>
                                    <a href="#" id="readyTest" data-id="<?php echo $selExamRow2['ex_id']; ?>">
                                        <?php
