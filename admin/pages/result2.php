...
<div class="app-main__outer">
                    ...
                    <div class="col-md-6 float-left">
                        <div class="card mb-3 widget-content bg-premium-dark">
                            <div class="widget-content-wrapper text-white">
                                ...
                                exam_id,exmne_id 
                            FROM exam_questions_atp eqt WHERE eqt.exam_id='$examId' AND eqt.exmne_id='$exmneId'");
                                        $totalSscoredata = $selScore1->fetch(PDO::FETCH_ASSOC);
                                        // print_r($totalSscoredata);die;
                                        ?>
                                        <span>
                                            <?php echo $totalSscoredata['correct_answers']; ?>
                                            <?php
                                ...
                                <div class="widget-content-right">
                                    <div class="widget-numbers text-white">
                                        ...
                                        <span>
                                            ...
                                            // $ans = $score / $over * 100;
                                            echo number_format($totalSscoredata['percentage'], 2);
                                            echo "%";
    ...
    <div class="col-12">
                    <button class="btn btn-danger">Send Result to Email</button>
                </div>
